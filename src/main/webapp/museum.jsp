		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
						...
						<div class="inner">
							<header>
								<h1>여기는&nbsp;&nbsp;누군가가&nbsp;소장한&nbsp;&nbsp;단&nbsp;&nbsp;하나만의&nbsp;&nbsp;작품을&nbsp;모아두었습니다.</h1>
								<h2>작가들의&nbsp;&nbsp;전혀&nbsp;&nbsp;다른&nbsp;&nbsp;감성을&nbsp;&nbsp;느껴보세요</h2><br/>
								<h2>현재&nbsp;&nbsp;전시&nbsp;&nbsp;작품&nbsp;&nbsp;보기&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&gt;<a href="Controller?type=shop">SHOP</a></h2>
							</header>
							...
							<%if(request.getAttribute("ar")!=null){
								...
								%>
									<article class="style<%=a %>">
										<span class="image">
											<img src="<%=vo.getP_sfile() %>" alt="<%=vo.getP_title() %>" style="max-height: 100%;max-width: 100%"/>
										</span>
										<a href="Controller?type=museumproductpage&viewidx=<%=vo.getP_idx()%>">
											<h2 style="color: #dddddd"><%=vo.getP_title() %></h2>
