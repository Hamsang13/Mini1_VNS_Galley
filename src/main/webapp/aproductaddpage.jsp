	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				...
				<div class = "row">
				<form action="Controller?type=awrite" method="post"
						...
						<tbody>
							...
							<tr>
								<td>
									...
									<small id="emailHelp" class="form-text text-muted">섬네일에 사용될 이미지를 등록해 주세요.</small>
								</td>
							</tr>
							<tr>
							
								<td><textarea name="content" cols="50" rows="8"
										id="content" data-str="내용"></textarea></td>
							</tr>
							<tr>
							
								<td><div class="input-group">
      								<span class="input-group-text">작가</span>
      								<input type="text" name="artist" size="40" class="form-control"
									data-str="작가" />
									</div>
									</td>
							</tr>
							...
							<td>
								<div class="input-group">
     								...
     								<input type="text" name="price" size="40" data-str="가격" class="form-control" placeholder="" />
							...
							<tr>
								...
								<td><div class="input-group">
      								...
      								<input type="text" name="cnt" size="40" data-str="수량" class="form-control"  />
      								</div></td>
							</tr>

							<tr>
								<td style="text-align: right;"><input type="button" value="뒤로" class ="btn btn-dark"
