...
public class productVO {
	...
	String p_idx,m_idx,p_title,p_content,p_sfile,p_price,p_status,p_cnt,p_artist,p_wait,p_secret,o_val1,o_val2 ,o_val3,o_val4;
	
	questionVO[] queslist;
	
	
	public questionVO[] getQueslist() {
		return queslist;
	}

	public void setQueslist(questionVO[] queslist) {
